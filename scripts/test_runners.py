...
def optimization(y, tX, method, degrees, gammas, lambdas, grad):
    ...
    Supplementary informations:
        This function first tests if the different arguments are empty or not. To have a 
        ubiquitous way of checking, every argument should be put inside a one element list.
        The variable 'param' inside this function is a list that regroup all these lists.
        Since every element in 'param' is a value stocked inside a one element list an 
        additional [0] is needed to access inside the argument.
        e.g. : degrees = [1, 2, 3, 4]
               to acces the third value of degrees -> degrees[0][3]
               param = [degrees, gammas]
               to access the third value of gammas -> param[1][0][3]
    """
    ...
    # Train for each different parameter
